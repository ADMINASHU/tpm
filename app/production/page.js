          ...
          {components.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-slate-400 h-48">
              ...
              <p className="text-sm font-medium">
                No tracking entries logged yet
              </p>
            </div>
          ) : (
      ...
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-6 flex flex-col">
        ...
        <div className="space-y-4 flex-1">
          ...
          <div className="flex justify-between items-center py-2 border-b border-slate-200">
            ...
            <span className="text-sm font-bold text-slate-900 text-emerald-600">
              ₹ 450.00/hr
            </span>
          </div>
          <div className="flex justify-between items-center py-2 border-b border-slate-200">
            ...
            <span className="text-sm font-bold text-slate-900 text-rose-600">
              + ₹ 145.00/unit
            </span>
          </div>
        </div>
...
function ComponentConfig() {
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-500 text-sm">
        Register electronic components, hardware, and packaging. Sets indent
        trigger levels.
      </p>
      <table className="w-full text-sm mt-4">
        <thead>
          <tr className="text-left text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-100">
            <th className="pb-3">Component Code</th>
            <th className="pb-3">Description</th>
            <th className="pb-3">Min Buffer</th>
          </tr>
        </thead>
