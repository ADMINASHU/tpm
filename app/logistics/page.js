            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="md:hidden flex space-x-1 p-1 bg-slate-200/50 rounded-xl w-fit">
                    <button onClick={() => setActiveTab("transfer")}
                        className={`px-6 py-2.5 text-sm font-semibold rounded-lg transition-all ${activeTab === "transfer" ? "bg-white text-indigo-700 shadow-sm ring-1 ring-slate-200" : "text-slate-500 hover:text-slate-700 hover:bg-slate-200/50"
                            }`}>Internal Stock Transfer</button>
                    <button onClick={() => setActiveTab("dispatch")}
                        className={`px-6 py-2.5 text-sm font-semibold rounded-lg transition-all ${activeTab === "dispatch" ? "bg-white text-indigo-700 shadow-sm ring-1 ring-slate-200" : "text-slate-500 hover:text-slate-700 hover:bg-slate-200/50"
                            }`}>External Dispatch</button>
                </div>
...
export default function LogisticsPage() {
    return <Suspense><LogisticsContent /></Suspense>;
}
    ...
    return (
        <div className="max-w-3xl">
            <div className="mb-8">
                ...
                <p className="text-sm text-slate-500 mt-1">Record outbound shipment of finished goods or spare parts to a customer or service center.</p>
            </div>

            <form className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Customer / Consignee</label>
                        <input type="text" className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" placeholder="e.g. Acme Corp" />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Dispatch From (Store)</label>
                        <select className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm bg-white">
                            <option>Finished Goods (Bengaluru)</option>
                            <option>Production Store (Bengaluru)</option>
                            <option>Raw Material Store (Bengaluru)</option>
                    ...
                    <div className="col-span-2">
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Delivery Address</label>
                        <input type="text" className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" placeholder="e.g. 12 Industrial Area, Pune, Maharashtra" />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Item / Serial No.</label>
                        <input type="text" className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" placeholder="Scan Serial or enter Bulk Name" />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Quantity</label>
                        <input type="number" min="1" className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" placeholder="1" />
                    </div>
                    <div>
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Mode of Dispatch</label>
                        <select className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm bg-white">
                    ...
                    <div>
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Vehicle / Tracking No.</label>
                        <input type="text" className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm" placeholder="e.g. KA01AB1234 or AWB-00912" />
                    </div>
                    <div className="col-span-2">
                        <label className="block text-sm font-semibold leading-6 text-slate-900 mb-1">Dispatch Notes</label>
                        <textarea rows={3} className="block w-full rounded-xl border-0 py-2.5 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm resize-none" placeholder="Any special handling instructions or reference PO number..." />
                    </div>
                </div>
