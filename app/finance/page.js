      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 rounded-xl transition-colors">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          ...
          <button className="w-full bg-slate-900 hover:bg-slate-800 text-white font-semibold py-2 rounded-xl transition-colors flex items-center justify-center gap-2">
            <RefreshCw className="w-4 h-4" /> Run True-Up Reconciliation
          </button>
        </div>
